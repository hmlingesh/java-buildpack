...
public class LoadFactorInterceptor implements InterceptorProbe {
    ...
    public void interceptionEnter(InterceptorContext context, Object object, Class declaringClass, String declaringClassName, String methodName, String methodSignature, Object[] parameters) {
        ...
        if (context.implementsInterface(declaringClass, TARGET_INTERFACE_NAME)) {
    ...
    @Override
    public void interceptionExit(InterceptorContext context, Class declaringClass, String declaringClassName, String methodName, String methodSignature, Object returnValue) {
        if (context.implementsInterface(declaringClass, TARGET_INTERFACE_NAME)) {
            ...
            if (payloadInfo != null && context.isPayloadStackEmpty()) {
                ...
                payloadInfo.calculateTime(context);
    ...
    @Override
    public void interceptionExceptionExit(InterceptorContext context, Class declaringClass, String declaringClassName, String methodName, String methodSignature, Throwable throwable) {
        if (context.implementsInterface(declaringClass, TARGET_INTERFACE_NAME)) {
            // ignore exceptions
            context.pop();
        }
