...
//
// Note: A 1.5 JRE is required for compiling and executing.
public class TestProfiler {
    ...
    private static void dumpPayloadHotSpots() {
        ...
        Collection<? extends ProfilingValue> hotspots = connection.getPayloadHotspots(LoadFactorInterceptor.class.getName(), null, Aggregation.CLASS, ThreadStatus.ALL);
